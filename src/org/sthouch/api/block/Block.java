...
public abstract interface Block {
	...
	/**
	 * <p>Modificar o Bloco com o ID de um novo Bloco/Material.</p>
	 * @param id ID Do Bloco.
	 */
	public abstract void setBlockTypeId(int id);
	 ...
	 * @return ID do Bloco.
	 */
	public abstract Integer getBlockTypeId();

	/**
	 * @author Pedro
	 * @return Localização do Bloco.
	 */
