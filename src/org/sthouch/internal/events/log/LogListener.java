 ...
 **/
package org.sthouch.internal.events.log;

import org.sthouch.api.events.console.ConsoleLogEvent;
import org.sthouch.api.listeners.MinecraftListener;
import org.sthouch.api.listeners.RegisteredEvent;

/**
 * Created by JonathanScripter on 20/set/2014 on 22:59
 */
public class LogListener implements MinecraftListener {
    @RegisteredEvent
    public void logEvent(ConsoleLogEvent event){
        //TODO Log Processing
    }
}
