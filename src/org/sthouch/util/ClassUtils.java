...
/**
 * Created by JonathanScripter on 19/set/2014 on 01:55
 */
public class ClassUtils {
    public static HashMap<Method, Annotation> getMethodsANN(final Class<?> type, final Class<? extends Annotation> annotation) {
